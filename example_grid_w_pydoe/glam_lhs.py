...
# save the list
DATA = n.transpose([list_omega_m, list_omega_b, list_sigma_8, list_h, list_ns, list_w0])
n.savetxt('cosmo_params.ascii', DATA, header = 'omega_m omega_b sigma_8 h ns w0 ')